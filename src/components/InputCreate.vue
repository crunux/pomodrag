...
<template>
  <div flex gap-2 items-center>
        <input border="~ mountain-400 focus:active:hover:mountain-900" w-40 ml-10 md:w-auto text-black:70 rounded-md id="chore" v-model="chore.content" aria-describedby="create-chore" @click.enter="createChore({content: chore.content, status: chore.status})"/>
